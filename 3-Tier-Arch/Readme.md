Here, we have a 3 tier architectur high level diagram. We are using GKE cluster to host application (Webserver and App server both) and a cloudsql DB with in GCP.
