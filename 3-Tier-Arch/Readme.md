Here, we have a 3 tier architectur high level diagram(Please refer GCP-3-Tier architecture.png image). We are using GKE cluster to host application (Webserver and App server both) and a cloudsql DB with in GCP.
